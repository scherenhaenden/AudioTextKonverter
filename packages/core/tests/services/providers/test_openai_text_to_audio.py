...
from audiotextkonverter.core.services.providers.openai_text_to_audio import OpenAITextToAudioService
...
def test_openai_text_to_audio_service_synthesize(mocker, mock_openai_client_for_tts):
    ...
    """
    # Arrange
    mocker.patch('audiotextkonverter.core.services.providers.openai_text_to_audio.OpenAI', return_value=mock_openai_client_for_tts)
